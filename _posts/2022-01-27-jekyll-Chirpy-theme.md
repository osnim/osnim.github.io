---
title: GitHub 블로그에 Chirpy jekyll 테마 (theme) 적용하기 (1)
author:
  name: osnim
...
여기서부터가 가장 중요합니다. chirpy는 다른 jekyll 테마와 달리 브랜치가 main이 아닌 chirpy 제작자가 만든 gh-pages라는 branch를 새로 생성해서 `bot`을 이용하여 자동으로 GitHub에 반영합니다.
